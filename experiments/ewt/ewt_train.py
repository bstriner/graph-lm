...
docker run -d -v /mnt/data/projects/graph-lm/output/ewt:/tb -p 6006:6006 tensorflow/tensorflow tensorboard --logdir /tb
docker run -d -v /mnt/data/projects/graph-lm/output/ewt/aae:/tb -p 6006:6006 tensorflow/tensorflow tensorboard --logdir /tb
docker run -d -v /mnt/data/projects/graph-lm/output/ewt/aae/ctc_flat:/tb -p 6006:6006 tensorflow/tensorflow tensorboard --logdir /tb
"""
...
if __name__ == '__main__':
    ...
    tf.flags.DEFINE_string('data_dir', '../../data/ewt/processed-small', 'Data directory')
    ...
    tf.flags.DEFINE_string('model_dir', '../../output/ewt/aae/ctc_flat/v10', 'Data directory')
