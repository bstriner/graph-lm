...
if __name__ == '__main__':
    ...
    tf.flags.DEFINE_string('model_dir', '../../output/ptb-character/aae/binary_tree/flat/v2', 'Data directory')
    #tf.flags.DEFINE_string('model_dir', '../../output/ptb-character/aae/binary_tree/attn/v6', 'Data directory')
